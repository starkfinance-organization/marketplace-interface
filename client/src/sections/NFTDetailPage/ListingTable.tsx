import TagIcon from "@/assets/svg/ic_tag.svg";
    ...
    <div className="w-full rounded-[6px] py-[24px] bg-[#24C3BC]/10 border border-[#24C3BC]/80">
      ...
      >
        <div className="flex items-center gap-5">
          <img src={TagIcon} alt="" className="w-[24px] h-[24px]" />
          <p className="font-bold text-[24px]">Listings</p>
        </div>
      ...
      >
        <div className="flex flex-col flex-1 border-t border-[#24C3BC]/80 ">
          <p className="text-xl text-center py-5">No listing Yet</p>
