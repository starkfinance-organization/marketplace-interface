  ...
  return (
    <div className="w-full pb-14 overflow-hidden">
      <div className="flex items-center justify-between lg:px-[90px] px-4">
        <p className="font-bold text-2xl text-white uppercase">Art </p>
        <button
      ...
      <div className="flex no-scrollbar whitespace-nowrap overflow-x-auto  lg:grid-flow-row lg:grid-rows-1 lg:grid-cols-4 gap-8 py-3 lg:mx-[90px] px-2">
