...
type ModalFilterProps = {
  isShowing: boolean;
  hide: () => void;
  isOpenRecentlyListed: boolean;
  setIsOpenEventRecentlyListed: React.Dispatch<React.SetStateAction<boolean>>;
  isOpenEvent: boolean;
                ...
                <div className="min-w-[230px]">
                  ...
                  <div className="min-w-[200px] relative">
                    <div className="flex w-full flex-col mt-3 border-[#24C3BC] border-b-[1px]">
                      <div
                        onClick={() => {
                          setIsOpenEventRecentlyListed(!isOpenRecentlyListed);
                        }}
